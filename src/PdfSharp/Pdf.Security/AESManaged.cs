...
namespace PdfSharp.Pdf.Security
{
    ...
    public class AESManaged
    {
                ...
                case 6:
                    {
                        ...
                        uint t3 = LE_To_UInt32(key, 12);
                        W[0][3] = t3;
                        uint t4 = LE_To_UInt32(key, 16);
                        W[1][0] = t4;
                        uint t5 = LE_To_UInt32(key, 20);
                        W[1][1] = t5;
                ...
                case 8:
                    {
                        ...
                        uint t5 = LE_To_UInt32(key, 20);
                        W[1][1] = t5;
                        uint t6 = LE_To_UInt32(key, 24);
                        W[1][2] = t6;
                        uint t7 = LE_To_UInt32(key, 28);
                        W[1][3] = t7;
        ...
        * inappropriate.
        */
        public void Init(bool forEncryption, KeyParameter keyParameter)
        {
            if (keyParameter == null)
                throw new ArgumentException("invalid parameter passed to AES init - " + nameof(KeyParameter), nameof(keyParameter));
        ...
        public int ProcessBlock(byte[] input, int inOff, byte[] output, int outOff)
        {
            ...
            CheckDataLength(input, inOff, 16, "input buffer too short");
            CheckDataLength(output, outOff, 16, "output buffer too short");
        ...
        private static void UInt32_To_LE(uint n, byte[] bs)
        {
            bs[0] = (byte)(n);
            bs[1] = (byte)(n >> 8);
            bs[2] = (byte)(n >> 16);
        ...
        private static void CheckDataLength(byte[] buf, int off, int len, string msg)
        {
